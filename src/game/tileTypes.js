...
const TileTypes = {
  ...
  4: { id:4, name:'EXIT',          solid:false, walkable:true,  color:CONSTANTS.COLOR_EXIT,         editorLabel:'⊡ EXIT',        editorColor:'#00ff88', unique:true, hidden: true },
  ...
  7: { id:7, name:'EXPLOSION',     solid:false, walkable:true,  color:CONSTANTS.COLOR_EXPLOSION,    editorLabel:'🔥 EXPLOSION',  editorColor:'#ff4400', hidden: true },
  8: { id:8, name:'UPGRADE_BOMB',  solid:false, walkable:true,  color:CONSTANTS.COLOR_UPGRADE_BOMB, editorLabel:'💣+ BOMB UP',   editorColor:'#ff6a00', hidden: true },
  9: { id:9, name:'UPGRADE_RANGE', solid:false, walkable:true,  color:CONSTANTS.COLOR_UPGRADE_RANGE,editorLabel:'🔥+ RANGE UP', editorColor:'#0099ff', hidden: true },
 10: { id:10,name:'UPGRADE_SPEED', solid:false, walkable:true,  color:CONSTANTS.COLOR_UPGRADE_SPEED,editorLabel:'⚡ SPEED UP',  editorColor:'#00ff88', hidden: true },
...
function isHidden(tileId)   { return TileTypes[tileId]?.hidden  ?? false; }
function isUnique(tileId)   { return TileTypes[tileId]?.unique  ?? false; }
